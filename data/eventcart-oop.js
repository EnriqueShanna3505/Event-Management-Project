function EventCart(localStorageKey) {
  const eventCart = {
    eventCartItems: undefined,
    loadFromStorage() {
      this.eventCartItems =
...
const eventCart = EventCart('cart-oop');
const businessEventCart = EventCart('cart-business');

eventCart.loadFromStorage();
...
businessEventCart.loadFromStorage();
